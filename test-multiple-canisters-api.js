...
import userManagementModule from './frontend/declarations/user_management/index.js';
import projectStoreModule from './frontend/declarations/project_store/index.js';
// Note: hackathon_store declarations not available, commenting out for now
// import hackathonStoreModule from './frontend/declarations/hackathon_store/index.js';

const userManagementIdl = userManagementModule.idlFactory;
const projectStoreIdl = projectStoreModule.idlFactory;
