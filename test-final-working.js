...
/**
 * Final Working ICP Canisters Testing Script
 * Tests canisters using proper DFINITY agent with anonymous identity
 * Run with: node test-final-working.js
 */
...
// Configuration
const CANISTER_IDS = {
  userManagement: Principal.fromText('vg3po-ix777-77774-qaafa-cai'), // Replace with actual canister ID
  projectStore: Principal.fromText('vu5yx-eh777-77774-qaaga-cai')   // Replace with actual canister ID
};
