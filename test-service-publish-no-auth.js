// Test script for service publish endpoint without authorization
const testData = {
  overview: {
...
async function testServicePublishNoAuth() {
  try {
    console.log('🧪 Testing service publish endpoint WITHOUT authorization...');
