...
export default function FreelancerOnboarding() {
  ...
  const handleContinue = (): void => {
    if (selectedType === 'client') {
      ...
      console.log('Navigating to freelancer onboarding...');
    }
  };
    ...
    <div className="min-h-screen bg-[#fcfcfc]">
      ...
      <main className="flex flex-col items-center justify-center px-6 py-16 max-w-6xl mx-auto">
        ...
        <div className="flex flex-col items-center gap-8">
          <Button
            size="lg"
            className="bg-gray-900 hover:bg-gray-800 text-white px-12 py-3 rounded-full shadow-lg hover:shadow-xl transition-all duration-200 text-lg font-medium disabled:opacity-50 disabled:cursor-not-allowed"
            onClick={handleContinue}
            disabled={!selectedType}
          >
            {getSelectedOption()?.buttonText || 'Select an Option'}
          </Button>
